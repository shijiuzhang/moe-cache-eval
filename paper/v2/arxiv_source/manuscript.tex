...
R\(^2\)=0.24 and, substituted for the oracle's input in the same
eviction and admission machinery, recovers \$-\$11.4\% of the gap: it is
worse than the causal baseline it was meant to improve.
...
archetype \textbar{} draw 1 \textbar{} draw 2 \textbar{} mean \textbar{}
improvement vs 17.81\% \textbar{} \$\pm\$1 s.d. of reference \textbar{}

\textbar---\textbar---:\textbar---:\textbar---:\textbar---:\textbar---\textbar{}
\textbar{} office / legal \textbar{} 8.76\% \textbar{} 8.15\% \textbar{}
8.45\% \textbar{} \textbf{52.5\%} \textbar{} 49.2 -- 55.5 \textbar{}
\textbar{} document RAG \textbar{} 10.57\% \textbar{} 10.69\% \textbar{}
10.63\% \textbar{} \textbf{40.3\%} \textbar{} 36.1 -- 44.0 \textbar{}
\textbar{} equipment / BOM \textbar{} 14.64\% \textbar{} 13.33\%
\textbar{} 13.99\% \textbar{} 21.5\% \textbar{} 15.9 -- 26.4 \textbar{}
\textbar{} ERP \textbar{} 17.33\% \textbar{} 15.18\% \textbar{} 16.25\%
\textbar{} 8.8\% \textbar{} 2.3 -- 14.4 \textbar{} \textbar{} process
diagnostics \textbar{} 17.65\% \textbar{} 16.34\% \textbar{} 16.99\%
\textbar{} 4.6\% \textbar{} \textbf{\$-\(2.2 – 10.5** |
...
\(\times\) three residency fractions \(\times\) three request-order
seeds \(\times\) twenty directed transitions between five workload
proxies \(\times\) four post-transition windows. A single unit exceeded
the threshold, at 10.74\%, and decayed to 6.83\%, 5.03\% and 3.95\% as
the window widened from 10 to 25, 50 and 100 requests, which is the
signature of a short-lived warm-start transient rather than a
sustainable control opportunity.
...
identity predicts a miss ratio of 1 \(-\) 0.723 = 27.99\% of
\textbf{union accesses}, and the simulator reports 27.99\% under that
denominator before adding the one-time preload. This is not the
pre-dedup effective-miss fraction used in Table 19. The identity is
...
The highest-ranked expert carries only 2.7\(\times\) the mass of the
lowest, and ranks 1--4 account for 63.5\% of the total. This says that
rank is a weak byte-allocation heuristic on this model. It does
...
disadvantage grows with expert count (\$-\$39.0\% at 64 experts,
\$-\(52.6% at 128); and within a single model it
grows as the regime becomes slacker (\)-\$52.6\% at \texttt{r\_bar} =
0.29, \$-\$87.9\% at \texttt{r\_bar} = 0.16). Both are consistent with
...
\begin{quote}
0.1415 \(\times\) 61.08\% + 0.1557 \(\times\) 61.08\% + 0.7028
\(\times\) 27.25\% = \textbf{37.30\%}
\end{quote}
...
2.3--3.7\(\times\). Hard partitioning may still lose there for the
sharing and duplication reasons, but it would not be excluded by
capacity arithmetic, and the \$-\$115.9\% figure must not be carried
across.
